...
PYBIND11_MODULE(ins_solver, module) {
  ...
  py::class_<Discretization1>(module, "SecondOrderCentered1")
      ...
      .def("Dx_p1", &Discretization1::Dx_p1<Mesh<10, 10>>)
      .def("Dx_p1", &Discretization1::Dx_p1<Mesh<20, 20>>)
  ...
  py::class_<Discretization3>(module, "SecondOrderCentered3")
      .def(py::init<const BConds_Part3 &>(), py::arg("boundaries"))
      .def("Dx_p1", &Discretization3::Dx_p1<Mesh<10, 10>>)
      .def("Dx_p1", &Discretization3::Dx_p1<Mesh<20, 20>>)
  ...
  py::class_<Assembly3, Discretization3>(module, "INSAssembly3")
      ...
      //        return self.boundaries();
      //      })
      .def("boundaries", &Assembly3::boundaries)
      .def("flux_integral", &Assembly3::flux_integral<Mesh<10, 10>>)
      .def("flux_integral", &Assembly3::flux_integral<Mesh<20, 20>>)
