...
class [[nodiscard]] SecondOrderCentered_Part2 {
 public:
  ...
  constexpr SecondOrderCentered_Part2(
      const SecondOrderCentered_Part2 &src) noexcept
      : SecondOrderCentered_Part2(src.T_0(), src.u_0(), src.v_0()) {}
